...
### 3. ~~RMSNorm~~ (DONE)
**Difficulty: Easy (~20 lines)** -- **Added in branch `conv-layers`**
...
### 4. ~~Additional Activation Functions~~ (DONE)
**Difficulty: Easy (~15 lines total)** -- **Added in branch `conv-layers`**
...
### 5. ~~GroupNorm & InstanceNorm~~ (DONE)
**Difficulty: Easy-Medium (~40 lines)** -- **Added in branch `norms-upsampling`**
...
### 6. ~~Upsampling Layers (Nearest, Bilinear, PixelShuffle)~~ (DONE)
**Difficulty: Easy (~30 lines)** -- **Added in branch `norms-upsampling`**
