...
class ResNet18(NN):
    ...
    def __init__(
        ...
        self.conv(self.input_shape[0], 64, kernel_size=3, stride=1, padding=1)
        self.batchnorm(64)
        self.relu()
        ...
        # Second block
        start_skip = self.get_num_layers()
        self.conv(64, 128, kernel_size=3, stride=2, padding=1)
        self.batchnorm(128)
        self.relu()
        ...
        # Third block
        start_skip = self.get_num_layers()
        self.conv(128, 256, kernel_size=3, stride=2, padding=1)
        self.batchnorm(256)
        self.relu()
        ...
        # Forth block
        start_skip = self.get_num_layers()
        self.conv(256, 512, kernel_size=3, stride=2, padding=1)
        self.batchnorm(512)
        self.relu()
